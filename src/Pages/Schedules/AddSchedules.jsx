...
const AddSchedules = () => {
    ...
    const getScreensByCity = async () => {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_API}/movie/screensbycity/${city.toLowerCase()}`)
      const data = await res.json()
    ...
    const createSchedule = async () => {
      ...
      const res = await fetch(`${import.meta.env.VITE_BACKEND_API}/movie/addmoviescheduletoscreen`, {
        method: 'POST',
        headers: {
